    ...
    <>
      <div className="w-full h-full flex flex-col justify-center items-center py-[20px]">
        <Image
          ...
          className={`${isDesktop
              ? "w-[170px] h-[170px]"
              : "2xl:w-[110px] xl:w-[100px] lg:w-[90px] md:w-[110px] sm:w-[90px] w-[90px] 2xl:h-[110px] xl:h-[100px] lg:h-[90px] md:h-[110px] sm:h-[90px] h-[90px]"
            } cursor-pointer z-10`}
          width={170}
          height={170}
        />
        ...
        >
          ...
          >
            ...
            >
              {notMatchPassRef.current
                ? "Passwords do not match"
                : "Password is incorrect (min 7 letters and 1 number)"}
            </div>
            <ButtonPrimary
              sizeClass={`${isDesktop
